...
from packages import edit_stuff
...
def randomly_move_point_feature(feature):
    ...
    lat_long_tuple = edit_stuff.convert_projection (coordinate_tuple=webmerc_coordinate_tuple, in_prj='epsg:3857', out_prj='epsg:4326')
...
def randomly_add_a_point_feature_to_feature_layer(feature_layer):
    ...
    random_feature = feature_set[random.randint(0, len(feature_set)-1)] #Grab a random feature from the feature set
